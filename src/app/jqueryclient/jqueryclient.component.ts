...
@Component({
  selector: 'app-jqueryclient',
  templateUrl: './jqueryclient.component.html',
  styleUrls: ['./jqueryclient.component.css']
})
export class JqueryclientComponent implements OnInit {
  ...
  ngOnInit() {
    $(document).ready(function () {
      ...
      function getUrl(port) {
        var url;
        if (port == 4200) {
          url = "http://localhost:8080/api/v1/spain-births";
        } else {
